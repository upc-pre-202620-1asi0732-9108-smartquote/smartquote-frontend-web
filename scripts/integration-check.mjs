...
import {
  IntegrationClient as SmartQuoteApi,
  parseSession,
} from "../tests/support/integration-client.js";
import { defaultCriteria } from "../src/evaluation-simulation/domain/evaluation-scenario.entity.js";
